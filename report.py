...
def run_audit(business, website, location):
    ...
    file_path = reports_dir / f"{safe_name}_Business_Snapshot_{timestamp}.txt"
...
==================================================
This Business Snapshot was generated by Rogers Holdings LLC to identify
digital optimization opportunities for the business.
...
def create_report(business, website, location):
    ...
    print("\n✅ Business Snapshot successfully created:")
